...
One of the limitations of this model is that it is highly sensitive to the data we use, and therefore we would get a different model whether we are creating the final tree plot just on the train set (= "weather_train"; yields 4 terminal nodes on the tree map), or on the whole (entire) data set (entirety of the training and testing set together = "weather" which yields 3 terminal nodes in ther tree map). 
